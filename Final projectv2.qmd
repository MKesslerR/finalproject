...
dist_precip_summary <- posmo |>
  group_by(Type, precip, distance) |> 
  summarise() |> 
  st_drop_geometry()  

mean(dist_precip_summary$distance[1:32]) # average distance of functional walks without rain 1341.88 m
mean(dist_precip_summary$distance[33:35]) # average distance of functional walks with rain 1474.13 m
mean(dist_precip_summary$distance[36:103]) # average distance of recreational walks without rain 4481.83 m
mean(dist_precip_summary$distance[104:112]) # average distance of recreational walks with rain 4538.88 m
...
mean(dist_type_tofday_summary$distance[22:33]) # average distance of functional morning walks 1253.86 m
