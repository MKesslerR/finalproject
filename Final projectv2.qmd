...
```{r}
#create sf object from coordinates to calculate distance to home
posmo |>
  group_by(trajectoryID) |>
...
T38 <- posmo %>%
  filter(trajectoryID == "T38")
T38 |> tm_shape() + tm_dots()
...
T11 |> tm_shape() + tm_dots()

T42 <- posmo %>%
  filter(trajectoryID == "T42")
T42 |> tm_shape() + tm_dots()

T27 |> tm_shape() + tm_dots()
T27 <- posmo %>%
...
posmo[3095:3105,] |> tm_shape() + tm_dots()
posmo[3235:3245,] |> tm_shape() + tm_dots()
posmo[3245:3250,] |> tm_shape() + tm_dots()
posmo[11575:11585,] |> tm_shape() + tm_dots()
posmo[17040:17050,] |> tm_shape() + tm_dots()

posmo[2125:3105,] |> tm_shape() + tm_dots()
posmo[3239:3255,] |> tm_shape() + tm_dots()
posmo[16570:16575,] |> tm_shape() + tm_dots()
posmo[11600:11612,] |> tm_shape() + tm_dots()
posmo[17085:17100,] |> tm_shape() + tm_dots()


#more than 100m
posmo[2330:2340,] |> tm_shape() + tm_dots()
