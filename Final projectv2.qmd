...
posmo_filter <- posmo |>
    filter(!static)
```
One trajectory with- (left) and without static points (right). A threshold of the average step mean of 50 meters was applied to filter out the static points that are below the defined threshold (Fig. 1).
